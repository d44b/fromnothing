...
(() => {
  const I18N = {
    pl: {
      ...
      "tour.info": "Info",
      "tour.row1.event": "Event: Serca na Kołach",
      "tour.more": "Chcecie nas zaprosić na kolejny event? Napiszcie przez formularz poniżej.",
    ...
    en: {
      ...
      "tour.info": "Info",
      "tour.row1.event": "Event: Serca na Kołach",
      "tour.more": "Want us at your next event? Drop a line via the form below.",
